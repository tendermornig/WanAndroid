...
import com.cl.wanandroid.databinding.ViewErrorBinding
...
class ErrorView @JvmOverloads constructor(
    ...
    fun showNoNetwork(
        @DrawableRes imageRes: Int = R.drawable.ic_no_network,
    ...
    fun showEmpty(
        @DrawableRes imageRes: Int = R.drawable.ic_empty,
        message: String = resources.getString(R.string.page_state_empty)
    ) {
        viewBinding.run {
            ivEmpty.setImageResource(imageRes)
            tvEmpty.text = message
    ...
    fun showNetworkError(
        retryOnClickListener: OnClickListener,
        @DrawableRes imageRes: Int = R.drawable.ic_network_error,
        message: String = resources.getString(R.string.page_state_network_error)
    ) {
        viewBinding.run {
            ivEmpty.setImageResource(imageRes)
            tvEmpty.text = message
